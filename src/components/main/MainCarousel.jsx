            ...
            <CarouselContent>
                <CarouselItem className='relative'>
                    ...
                    <div className="absolute z-20 top-0 w-full h-full items-center justify-center flex px-[5%] ">
                        <p className="text-4xl font-semibold tracking-wide text-center text-white md:text-6xl/snug font-merriwether">Welcome to <br /> सिद्धार्थ स्मारक माध्यमिक विद्यालय </p>
                    </div>
